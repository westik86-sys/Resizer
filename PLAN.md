...
качество `0,45`, AAC 96 кбит/с либо без аудио, если оно было выключено в быстром
режиме. Эта политика не показывается как пресет перед первым запуском.
...
- В гибком режиме — native Slider качества, Picker разрешения, Picker FPS и
  toggle звука.
- Краткое резюме, например: `MP4 · H.264 · до 1080p · до 30 FPS · AAC`.
...
- quick recipe: quality 0.65, максимум 1080p/30 FPS, AAC 128 кбит/с либо
  удаление audio;
- flexible: quality 0.30...0.90, source/1080p/720p/480p,
  source/60/30/24 FPS, keep/remove audio;
- compact retry: quality 0.45, максимум 720p/24 FPS, AAC 96 кбит/с либо без
  аудио — в соответствии с выбором Quick;
...
Не добавляй arbitrary FFmpeg flags, выбор codec/container/bitrate,
