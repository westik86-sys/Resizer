...
LDFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -arch arm64 -mmacosx-version-min=14.0 -lm -arch arm64 -lpthread
LDFLAGSCLI=
LIBX264=libx264.a
CLI_LIBX264=$(LIBX264)
...
ASFLAGS= -I. -I$(SRCPATH) --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -arch arm64 -mmacosx-version-min=14.0 -DPREFIX -DPIC -arch arm64 -c -DSTACK_ALIGNMENT=16
RC=
RCFLAGS=
EXE=
HAVE_GETOPT_LONG=1
