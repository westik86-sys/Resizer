...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/resizer-toolchain/ffmpeg/8.1.2-profile7/arm64 --target-os=darwin --arch=aarch64 --cpu=generic --enable-cross-compile --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk --cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --ar=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ar --ranlib=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ranlib --strip=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/strip --pkg-config=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7/pkg-config-disabled --extra-cflags='-arch arm64 -mmacosx-version-min=14.0 -ffile-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -fdebug-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -fmacro-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7' --extra-ldflags='-arch arm64 -mmacosx-version-min=14.0' --disable-autodetect --disable-everything --disable-network --disable-avdevice --disable-ffplay --disable-doc --disable-debug --disable-shared --enable-static --disable-x86asm --disable-iconv --disable-audiotoolbox --enable-videotoolbox --enable-ffmpeg --enable-ffprobe --enable-protocol=fd --enable-protocol=file --enable-protocol=pipe --enable-demuxer=mov --enable-muxer=mp4 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=aac --enable-parser=h264 --enable-parser=hevc --enable-parser=aac --enable-encoder=h264_videotoolbox --enable-encoder=aac --enable-filter=scale --enable-filter=aresample --fatal-warnings
prefix=/opt/resizer-toolchain/ffmpeg/8.1.2-profile7/arm64
...
CFLAGS=  -arch arm64 -mmacosx-version-min=14.0 -ffile-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -fdebug-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -fmacro-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -std=c17 -Werror=partial-availability -mdynamic-no-pic -fno-common -fomit-frame-pointer -fPIC -pthread -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
ASFLAGS=  -arch arm64 -mmacosx-version-min=14.0 -ffile-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -fdebug-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -fmacro-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile7=/usr/src/resizer-ffmpeg/8.1.2-profile7 -mdynamic-no-pic -fPIC -Qunused-arguments
GLSLCFLAGS=
...
EXTRALIBS-avcodec=-lm -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
