SRCPATH=../x264-source
prefix=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile10/x264-prefix-x86_64
exec_prefix=${prefix}
...
CFLAGS=-Wshadow -O3 -ffast-math -m64  -Wall -I. -I$(SRCPATH) --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -arch x86_64 -mmacosx-version-min=14.0 -ffile-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile10=/usr/src/resizer-ffmpeg/8.1.2-profile10 -fdebug-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile10=/usr/src/resizer-ffmpeg/8.1.2-profile10 -fmacro-prefix-map=/private/tmp/com.example.Resizer.ffmpeg-build/8.1.2-profile10=/usr/src/resizer-ffmpeg/8.1.2-profile10 -arch x86_64 -std=gnu99 -D_GNU_SOURCE -mstack-alignment=64 -fPIC -fomit-frame-pointer -fno-tree-vectorize -fvisibility=hidden
CFLAGSSO=
CFLAGSCLI=
COMPILER=GNU
COMPILER_STYLE=GNU
