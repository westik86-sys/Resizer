...
- Corresponding source: included in the version-matched source archive under `Open Source`, and retained at `Vendor/FFmpeg/sources/ffmpeg-8.1.2.tar.xz`
...
- Corresponding source: included in the version-matched source archive under `Open Source`, and retained at `Vendor/x264/sources/x264-0480cb05fa188d37ae87e8f4fd8f1aea3711f7ee.tar.gz`
